...
Es una base funcional pero simple. 
Los ascensores se mueven en una dirección fija (por implementar lógica más compleja).
...
- [ ] fijar ea estilo pep los nombres de librerias, clases y ficheros.
